...
import prefubanner from "../../assets/img/perfferd-partner-banner.jpg";
const customStyles = {
  content: {
    top: '50%',
    left: '50%',
  ...
  return (
    <div className="preferredpartner_page_wrapper">
      <div className="education_pro_banner">
        <img src={prefubanner} alt="study_banner" />
      </div>
                ...
                <Row>
                  <Col xs="12" xl="6" md="6">
                    <div className="form-group">
                      <input type="text" class="form-control grey-input" placeholder="Enter Business Name" required onChange={(e) => { this.setState({ ...this.state, provider_name: e.target.value }) }} />
                    </div>
                  </Col>
                  <Col xs="12" xl="6" md="6">
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <select id="country_code" name="country" class="form-control" onChange={(e) => {
